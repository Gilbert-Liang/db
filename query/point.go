...
func encodeAux(aux []interface{}) []*internal.Aux {
	...
	for i := range aux {
		switch v := aux[i].(type) {
		case float64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Float)), FloatValue: proto.Float64(v)}
		case *float64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Float))}
		case int64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Integer)), IntegerValue: proto.Int64(v)}
		case *int64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Integer))}
		case uint64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Unsigned)), UnsignedValue: proto.Uint64(v)}
		case *uint64:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Unsigned))}
		case string:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.String)), StringValue: proto.String(v)}
		case *string:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.String))}
		case bool:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Boolean)), BooleanValue: proto.Bool(v)}
		case *bool:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Boolean))}
		default:
			pb[i] = &internal.Aux{DataType: proto.Int32(int32(cnosql.Unknown))}
		}
	}
	return pb
}
...
func decodeAux(pb []*internal.Aux) []interface{} {
	...
	for i := range pb {
		switch cnosql.DataType(pb[i].GetDataType()) {
		case cnosql.Float:
