...
func (f *LogFile) AddSeriesList(seriesSet *tsdb.SeriesIDSet, names [][]byte, tagsSlice []model.Tags) ([]uint64, error) {
...
type LogEntry struct {
	...
	tags     model.Tags // series tags, this is a cached copied of the parsed tags
