...
func (idx *SeriesIndex) FindIDByNameTags(segments []*SeriesSegment, name []byte, tags model.Tags, buf []byte) uint64 {
...
func (idx *SeriesIndex) FindIDListByNameTags(segments []*SeriesSegment, names [][]byte, tagsSlice []model.Tags, buf []byte) (ids []uint64, ok bool) {
