...
type FieldValidator interface {
	Validate(mf *MetricFields, point model.Point) error
}
...
func (defaultFieldValidator) Validate(mf *MetricFields, point model.Point) error {
...
func dataTypeFromModelsFieldType(fieldType model.FieldType) cnosql.DataType {
	switch fieldType {
	case model.Float:
		return cnosql.Float
	case model.Integer:
