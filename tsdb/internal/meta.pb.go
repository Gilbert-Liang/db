...
func (m *MetricFields) Reset()         { *m = MetricFields{} }
func (m *MetricFields) String() string { return proto.CompactTextString(m) }
func (*MetricFields) ProtoMessage()    {}
func (*MetricFields) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_3108ecf7b17f779e, []int{2}
}
func (m *MetricFields) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MetricFields) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MetricFields.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MetricFields) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricFields.Merge(dst, src)
}
func (m *MetricFields) XXX_Size() int {
	return m.Size()
}
func (m *MetricFields) XXX_DiscardUnknown() {
	xxx_messageInfo_MetricFields.DiscardUnknown(m)
}

var xxx_messageInfo_MetricFields proto.InternalMessageInfo

func (m *MetricFields) GetName() []byte {
	if m != nil {
		return m.Name
	}
	return nil
...
func (m *MetricFields) GetFields() []*Field {
	if m != nil {
		return m.Fields
	}
	return nil
...
type MetricFieldSet struct {
	Metrics              []*MetricFields `protobuf:"bytes,1,rep,name=Metrics" json:"Metrics,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *MetricFieldSet) Reset()         { *m = MetricFieldSet{} }
func (m *MetricFieldSet) String() string { return proto.CompactTextString(m) }
func (*MetricFieldSet) ProtoMessage()    {}
func (*MetricFieldSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_meta_3108ecf7b17f779e, []int{4}
}
func (m *MetricFieldSet) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MetricFieldSet) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MetricFieldSet.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MetricFieldSet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricFieldSet.Merge(dst, src)
}
func (m *MetricFieldSet) XXX_Size() int {
	return m.Size()
}
func (m *MetricFieldSet) XXX_DiscardUnknown() {
	xxx_messageInfo_MetricFieldSet.DiscardUnknown(m)
}

var xxx_messageInfo_MetricFieldSet proto.InternalMessageInfo

func (m *MetricFieldSet) GetMetrics() []*MetricFields {
	if m != nil {
		return m.Metrics
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MetricFields)(nil), "tsdb.MetricFields")
	proto.RegisterType((*Field)(nil), "tsdb.Field")
	proto.RegisterType((*MetricFieldSet)(nil), "tsdb.MetricFieldSet")
}
...
func (m *MetricFields) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MetricFields) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MetricFieldSet) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MetricFieldSet) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MetricFields) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *MetricFieldSet) Size() (n int) {
	var l int
	_ = l
	if len(m.Metrics) > 0 {
...
func (m *MetricFields) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricFields: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricFields: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MetricFieldSet) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricFieldSet: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricFieldSet: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Metrics = append(m.Metrics, &MetricFields{})
